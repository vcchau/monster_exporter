...
for monster_id in json:
    try:
        ...
        sql = '''INSERT INTO monsters ( id,
            ...
            %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s );''' % (monster.id, monster.name, monster.incomplete, monster.members,
            ...
            monster.duplicate, str(monster.examine), monster.icon, monster.wiki_name, 
            monster.wiki_url, monster.attack_level, monster.strength_level, monster.defence_level, monster.magic_level,
